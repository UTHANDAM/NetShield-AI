      ...
      <div className="w-full max-w-md bg-card border border-border rounded shadow-2xl p-8 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs text-text-muted mb-1.5 uppercase tracking-wider">Operator ID (Email)</label>
            ...
            <div>
              <label className="block text-xs text-text-muted mb-1.5 uppercase tracking-wider">Access Code</label>
              <div className="relative">
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-text-muted">
              ...
              <Link href="/register" className="text-threat hover:underline">
                Request Access
              </Link>
            </p>
          </div>
